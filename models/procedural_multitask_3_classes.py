...
annotation_1 = annototation_type.asymmetry
annotation_2 = annototation_type.border
...
def read_data(seed):
    ...
    train_id, valid_id, test_id, train_label_c, valid_label_c, test_label_c, train_label_a_1, valid_label_a_1, test_label_a_1, train_mask_1, valid_mask_1, test_mask_1, class_weights_1 = get_data_2(
        GROUP_PATH, TRUTH_PATH, TRUTH_CSV, seed, VERBOSE, SANITY_CHECK, annotation_1)
    _, _, _, _, _, _, train_label_a_2, valid_label_a_2, test_label_a_2, train_mask_2, valid_mask_2, test_mask_2, class_weights_2 = get_data_2(
        GROUP_PATH, TRUTH_PATH, TRUTH_CSV, seed, VERBOSE, SANITY_CHECK, annotation_2)
...
def build_model():
    ...
    model = keras.models.Model(conv_base.input, outputs=[out_class, label_2, label_3])
    model.compile(
        optimizer=keras.optimizers.RMSprop(lr=2e-5),
        loss={'out_class': 'binary_crossentropy', 'label_2': 'mse', 'label_3': 'mse'},
        loss_weights={'out_class': 0.5, 'label_2': 0.25, 'label_3': 0.25},
